...
public class NPCMono : MonoBehaviour, IInteractable, ISavable
{
    [Header("Quests")]
    ...
    public IEnumerator Interact(Transform initiator)
    {
        if (state == NPCState.idle && GameManager.Instance.State == GameState.freeRoam)
        {
            ...
            {
                yield return pokemonGiver.GivePokemon(initiator.GetComponent<PlayerMovement>());
            }
            ...
            else if (activeQuest != null)
            {
                ...
                {
                    yield return DialogueCacheManager.I.ShowDialogue(activeQuest.Base.InProgressDialogue);
                }
